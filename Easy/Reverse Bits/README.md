<h2><a href="https://www.geeksforgeeks.org/problems/reverse-bits3556/1">Reverse Bits</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a <strong>32 bit number X</strong>, <strong>reverse </strong>its binary form and print the answer in decimal.</span></p>
